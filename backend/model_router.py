...
HEAVY_LLM_COMMANDS: Set[str] = {
    ...
    # Domain normalization (learning layer model)
    "domain-extract-topics",
    "domain-determine-layers",
    "domain-classify",
    "domain-generate-subdomains",
    
    # Subdomain validation (semantic deduplication)
    "subdomain-validation",
    
    # Lesson Engine (retrieval + step generation)
    "quest-subdomain-gen",
    "lesson-engine",
}
